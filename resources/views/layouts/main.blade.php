    ...
    <script>
        WebFont.load({
            ...
            custom: {
                ...
                urls: ['/backend/css/fonts.min.css']
            },
            active: function() {
...
<body>
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="/backend/img/profile.jpg"
                ...
                <div class="sidebar-content">
                    <div class="user">
                        <div class="avatar-sm float-left mr-2">
                            <img src="/backend/img/profile.jpg" alt="..." class="avatar-img rounded-circle">
                        </div>
                        <div class="info">
    ...
    <!-- Chart JS -->
    <script src="/backend/js/plugin/chart.js/chart.min.js"></script>

    <!-- jQuery Sparkline -->
    <script src="/backend/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

    <!-- Chart Circle -->
    <script src="/backend/js/plugin/chart-circle/circles.min.js"></script>

    <!-- Datatables -->
    <script src="/backend/js/plugin/datatables/datatables.min.js"></script>

    <!-- Bootstrap Notify -->
    <script src="/backend/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>

    <!-- jQuery Vector Maps -->
    <script src="/backend/js/plugin/jqvmap/jquery.vmap.min.js"></script>
    <script src="/backend/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>
